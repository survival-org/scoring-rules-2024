...
Since the latter is typically associated with smaller loss values, the average RCLL decreases as censoring increases.
Absolute RCLL scores are therefore most informative for comparing models within the same dataset (but ranks remain meaningful across datasets).
