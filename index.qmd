...
We use it to generate two tasks, one with a low censoring rate and one with a high censoring rate, and save them as [`tasks.rds`](https://github.com/survival-org/scoring-rules-2024/blob/main/simulation_benchmark/tasks.rds).
- [train.R](https://github.com/survival-org/scoring-rules-2024/blob/main/simulation_benchmark/train.R): Trains all models on the generated tasks.
...
The panels below show the relationship between excess loss and MIAE for four commonly used evaluation metrics:
...
The results for $n = 250$ correspond to Figure 7 and Tables 3 and C2 in the manuscript.
