...
#| fig-width: 9
#| fig-height: 6
plot_score_diff_by_ntest(res, measure_id = "rcll", task_id_val = "low", legend_position = "bottom")
```

```{r}
#| fig-width: 9
#| fig-height: 6
plot_score_diff_by_ntest(res, measure_id = "isbs", task_id_val = "low", legend_position = "bottom")
```
...
#| fig-width: 9
#| fig-height: 6
plot_score_diff_by_ntest(res, measure_id = "rcll", task_id_val = "high", legend_position = "bottom")
```

```{r}
#| fig-width: 9
#| fig-height: 6
plot_score_diff_by_ntest(res, measure_id = "isbs", task_id_val = "high", legend_position = "bottom")
```
